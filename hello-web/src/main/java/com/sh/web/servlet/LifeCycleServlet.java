 ...
 * Servlet 생명주기
 * - HttpServlet 상속
 * - Tomcat에 의해서 싱글턴(프로그램당 객체를 하나만 만들어서 재사용)객체로 관리
 *
 ...
 *
 * 	6. 서버 종료 시 destroy메소드 호출
 * 	7. @PreDestroy 메소드 호출
 * 	8. (자원반납)
 */
@WebServlet("/lifecycle.do") //java.lang.IllegalArgumentException: 서블릿 매핑에서 유효하지 않은 <url-pattern> [lifecycle.do]
